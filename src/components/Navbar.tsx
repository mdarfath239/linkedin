...
import TryPremiumModal from "./TryPremiumModal";
      ...
      <nav className="bg-white flex items-center justify-between px-4 py-2 border-b shadow-sm z-30 relative">
        ...
        <div className="flex items-center gap-8">
          ...
          <button 
            ...
            className="bg-transparent outline-none border-0 flex flex-col items-center gap-1 px-2 py-1 transition text-amber-600 hover:text-amber-700"
          >
            <Award size={24} />
